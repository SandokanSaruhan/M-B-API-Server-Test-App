...
$(document).ready(function () {
	...
	var ready = false,
			...
			// Stores the total amount of images we have in the sequence //SANDO IMPORTANT
			totalFrames = 36,
	...
	*/
	function loadImage() {
		...
		// Generates the image file name using the incremented "loadedImages" variable //SANDO IMPORTANT
		var imageName = "img_product/angle" + (loadedImages + 1) + ".png";
		/*
	...
	* and calls the "showsando" method, that displays the image slider.
	*/
	function imageLoaded() {
		...
		if (loadedImages == totalFrames) {
			...
			/*
				...
				When the preloader is completely faded, it stops the preloader rendering and calls the "showSando" function to display the images.
			*/
